...
export async function GET(request:Request){
  ...
  // Usuários são uma parte independente da busca e não devem depender do feed social.
  ...
  // O feed pode ainda não existir no banco enquanto as migrações sociais estão sendo aplicadas.
  // Nesse caso, mantemos a busca de usuários e destinos funcionando normalmente.

...
type Event = { id: string; title: string; description: string | null; event_date: string | null; start_time: string | null; end_time: string | null; location_id: string | null; day_index: number; status: Status; color: string };
...
export default function TripDetailClient({ tripId, initialLocations, initialEvents = [] }: { tripId: string; initialLocations: Location[]; initialEvents?: Event[] }) {
  ...
  const [eventForm, setEventForm] = useState({ title: "", description: "", event_date: "", start_time: "", end_time: "", location_id: "", day_index: "1", status: "future" as Status, color: "#111827" });
